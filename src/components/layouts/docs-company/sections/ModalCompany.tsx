...
const CompanyModals = ({
  ...
  useEffect(() => {
    if (selectedCompany) {
      form.setFieldsValue({
        ...selectedCompany,
        start_audit_period: selectedCompany.start_audit_period
          ? selectedCompany.start_audit_period
          : null,
        end_audit_period: selectedCompany.end_audit_period
          ? selectedCompany.end_audit_period
          : null,
      });
    } else {
      form.resetFields();
    ...
    >
      {modalType === "view" && selectedCompany && (
        <div>
          ...
          <p>
            <strong>Tahun Penugasan:</strong>{" "}
            {selectedCompany.year_of_assignment}
          </p>
          <p>
