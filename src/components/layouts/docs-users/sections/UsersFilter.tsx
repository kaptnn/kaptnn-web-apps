...
const UserFilters = () => {
  ...
  return (
    <div>
      <input value={sort} onChange={(e) => setSort(e.target.value)} placeholder="Sort field" />
      <input value={order} onChange={(e) => setOrder(e.target.value)} placeholder="Order" />
      <input value={page} onChange={(e) => setPage(Number(e.target.value))} placeholder="Page" type="number" />
      <input value={limit} onChange={(e) => setLimit(Number(e.target.value))} placeholder="Limit" type="number" />
